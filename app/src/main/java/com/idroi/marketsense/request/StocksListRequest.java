...
public class StocksListRequest extends Request<ArrayList<Stock>> {
    ...
    public StocksListRequest(int method, String url, Map<String, String> headers, Response.Listener<ArrayList<Stock>> listener, Response.ErrorListener errorListener) {
